  ...
  public:
    ...
    */
    ...
    /*!
      ...
      \param cell_size_ratio The ratio of the cell size in the Cartesian
      grid to the neighborhood radius. For example, if the cell size ratio
      is 0.5 then the cells will be half the size of the neighborhood radius
      in each dimension.
...
//---------------------------------------------------------------------------//
//! CSR N2NeighborList NeighborList interface.
...
//---------------------------------------------------------------------------//
//! 2D N2NeighborList NeighborList interface.
template <class MemorySpace, class AlgorithmTag, class BuildTag>
class NeighborList<
