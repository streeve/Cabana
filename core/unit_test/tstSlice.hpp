...
void randomAccessTest()
{
    ...
    // Create slices.
    auto da_slice_0 = Cabana::slice<0>( "da_s0", aosoa );
    auto da_slice_1 = Cabana::slice<1>( "da_s1", aosoa );
    auto da_slice_2 = Cabana::slice<2>( "da_s2", aosoa );
    auto da_slice_3 = Cabana::slice<3>( "da_s3", aosoa );
    ...
    auto slice_0 = Cabana::slice<0>( "s0_2", aosoa_2 );
    auto slice_1 = Cabana::slice<1>( "s1_2", aosoa_2 );
    auto slice_2 = Cabana::slice<2>( "s2_2", aosoa_2 );
    auto slice_3 = Cabana::slice<3>( "s3_2", aosoa_2 );
...
void atomicAccessTest()
{
    ...
    auto slice = Cabana::slice<0>( "s0", aosoa );
    ...
    auto mirror =
        Cabana::create_mirror_view_and_copy( Kokkos::HostSpace(), aosoa );
    auto mirror_slice = Cabana::slice<0>( "s0", mirror );
