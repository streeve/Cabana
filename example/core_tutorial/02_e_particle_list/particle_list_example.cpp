...
//---------------------------------------------------------------------------//
// Particle List example.
//---------------------------------------------------------------------------//
void particleListExample()
{
    /*
      Cabana particle lists store the AoSoA data with convenient particle field
      type tags and per-particle thread-level access. SoAs. A Cabana AoSoA
      provides a convenient interface to create and manipulate these lists.
    */

    /*
      Whereas all the previous data structure examples begin with AoSoA data
      types, the ParticleList instead uses type tags which are used to determine
      them internally.
    */
